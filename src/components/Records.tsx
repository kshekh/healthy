...
const Record = ({ image, title, subtitle }: Props) => {
  return (
    <div
      className='relative w-72 h-72 flex flex-col items-center justify-center border-[24px] border-primary-300 mx-6 my-14 bg-cover'
      style={{
